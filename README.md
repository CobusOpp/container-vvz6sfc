...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vvz6sfc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vvz6sfc.containers.anotherwebservice.com/
...
```
git clone git@github.com:CobusOpp/container-vvz6sfc.git
cd container-vvz6sfc
```
...
```
docker attach container-vvz6sfc
```
